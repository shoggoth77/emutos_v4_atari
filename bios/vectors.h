...
#if CONF_WITH_MFP
/* MFP interrupt vectors, default addresses */
#define VEC_MFP_SBE (*(volatile PFVOID*)0x128) /* Send buffer empty */
#define VEC_MFP_RBF (*(volatile PFVOID*)0x130) /* Rceive buffer full */
#endif
