...
//#define ide_interface2 ((volatile struct IDE*)0x00dd0000)
int amiga_sendI2C(UBYTE address, UWORD bytes, UBYTE* buffer);
int amiga_recvI2C(UBYTE address, UWORD bytes, UBYTE* buffer);
...
LONG amiga_sndstatus(WORD reset);
LONG amiga_buffoper(WORD mode);
LONG amiga_soundcmd(WORD mode, WORD data);
...
void amiga_int_1(void);
void amiga_int_2(void);
void amiga_int_3(void);
void amiga_int_4(void);
void amiga_int_5(void);
void amiga_int_6(void);

extern void amiga_setup_timer(WORD timer);
extern void amiga_jenabint(WORD num);
extern void amiga_jdisint(WORD num);
extern void amiga_sound_vector(WORD timer, LONG vector);
